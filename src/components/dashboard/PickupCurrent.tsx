          ...
          <div className="w-816pxr ml-24pxr mt-27pxr flex justify-between">
            <div className="flex flex-col  w-112pxr">
              ...
              <div className="flex text-center justify-center">
                <div className="text-36pxr font-bold text-nav-btn">1,234</div>
            ...
            <div className="flex flex-col w-112pxr">
              ...
              <div className="flex text-center justify-center">
                <div className="text-36pxr font-bold text-nav-btn">0</div>
                <div className="text-16pxr font-medium text-text-gray ml-4pxr mt-18pxr">
                  건
                </div>
              </div>
            ...
            <div className="flex flex-col w-112pxr">
              ...
              <div className="flex text-center justify-center">
                <div className="text-36pxr font-bold text-nav-btn">12</div>
                <div className="text-16pxr font-medium text-text-gray ml-4pxr mt-18pxr">
                  건
                </div>
              </div>
            ...
            <div className="flex flex-col w-112pxr">
              ...
              <div className="flex text-center justify-center">
                <div className="text-36pxr font-bold text-nav-btn">123</div>
                <div className="text-16pxr font-medium text-text-gray ml-4pxr mt-18pxr">
                  건
                </div>
              </div>
